...
window.chatBox = (function() {
  ...
  return {clear, writePartnerMessage, writeTyping ,writeSytemInfo, changeChatMode};
  ...
  function writeSytemInfo(code) {
    ...
    switch (code) {
      ...
      case 'partner_disconnected':
        $syslog.append('<p class="syslog"><strong>Sorry. Stranger has disconnected. They didn\'t deserve you.</strong></p>');
      ...
      case 'server_disconnection':
        $syslog.append('<p class="syslog error"><strong>Oh no! System error! Please refresh this page!</strong></p>');
        break;
      default:
        $syslog.append(code);
        break;
  ...
  function writeTyping(msg) {
    console.log("123h_recv");
    $(".type").text("Stranger is Typing...");
